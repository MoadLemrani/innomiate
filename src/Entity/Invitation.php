...
class Invitation
{
    ...
    public function getSenderParticipant(): ?Participant { return $this->senderParticipant; }
    public function setSenderParticipant(?Participant $senderParticipant): self { $this->senderParticipant = $senderParticipant; return $this; }

    public function getReceiverParticipant(): ?Participant { return $this->receiverParticipant; }
    public function setReceiverParticipant(?Participant $receiverParticipant): self { $this->receiverParticipant = $receiverParticipant; return $this; }
